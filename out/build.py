# python build stubs for package go_in_python_example
...
mod = Module('_go_in_python_example')
mod.add_include('"go_in_python_example_go.h"')
...
add_checked_string_function(mod, 'go_in_python_example_ReturnHelloWorld', retval('char*'), [])

mod.generate(open('go_in_python_example.c', 'w'))
